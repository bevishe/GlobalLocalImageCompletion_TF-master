...
parser.add_argument('--train_step', dest='train_step', default=300, help='total number of train_step')
parser.add_argument('--Tc', dest='Tc', default=54, help='Tc to train Completion Network')
parser.add_argument('--Td', dest='Td', default=6, help='Td to train Discriminator Network')
...
#Test image
parser.add_argument('--img_path', dest='img_path', default='./test/test.jpg', help='test image path')

#Extra folders setting
#定义checkpoint，image，graph文件夹路径
